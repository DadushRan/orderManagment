...
export default function User(props) {
  ...
  return (
        <div style={{marginTop:'5px'}}>
          ...
          <div style={{boxSizing:'-moz-initial', color:'#FFFFFF',backgroundColor:'#1771E6', width:'20%',height:'100px', marginRight:'auto',marginLeft:'auto', border:'1.5px solid black', borderRadius:'5px', boxShadow: '0 4px 8px 0 rgba(0, 0, 0, 0.2),0 6px 20px 0 rgba(0, 0, 0, 0.19)'}}>
